...
export default function ShopPage() {
  ...
  // Available categories list matching live site
  ...
  const filteredProducts = allProducts.filter((product) => {
    ...
    const matchesCategory =
      ...
      selectedCategories.some((selectedCat) => {
        ...
        if (sc.includes("batter"))
          return cat.includes("batter") || cat.includes("storage");
        if (sc.includes("invert")) return cat.includes("invert");
        if (sc.includes("power bank"))
          return cat.includes("power") || cat.includes("bank");
        if (sc.includes("solar panel"))
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="container mx-auto px-4 md:px-8 pt-16 pb-10 flex-grow">
        ...
        {/* Heading matching live site ("All" in dark, "Products" in green) */}
